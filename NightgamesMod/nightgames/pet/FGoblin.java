...
public class FGoblin extends Pet {
    ...
    public void caught(Combat c, Character captor) {
        if(owner().human()){
            ...
            c.write(captor, Global.format("{other:SUBJECT-ACTION:manage|manages} to catch {self:name-do} fetish goblin by her bondage gear, keeping her from escaping. It's not immediately clear how {other:pronoun} can "
