...
public class FairyMale extends Pet {   
    ...
    public void caught(Combat c, Character captor) {
        if (captor.human()) {
            ...
            c.write(captor, Global.format("{other:SUBJECT-ACTION:snatch|snatches} {self:name-do} out of the air and flicks the fairy's little testicles with {other:possessive} finger. %s in sympathy as the tiny male curls up in the fetal position "
