...
public class LevelDrainModifier extends BaseModifier {
    ...
    public String intro() {
        return "<i>\"" + Global.getPlayer().getName() + ", don't you think you are getting a bit too strong? "
             + "The others aren't really winning many matches any more! The benefactor doesn't like that, oh no he doesn't. Technically, I'm supposed to put you "
             + "in a different rotation with more difficult opponents, but the others seems vehemently against it. Isn't it nice to be loved? "
             ...
             + "Well this is the advanced version of the stuff, one swallow and they'll drain the strength right out of you. Permanently. "
    ...
    public String acceptance() {
        return "Lilly nods approvingly as you accept. <i>\"Good! I'm glad I don't have to pull you out of these matches.\"</i> She chuckles. "
                        + "<i>\"Pulling out is going to be tricky for everyone tonight...\"</i>";
    }
