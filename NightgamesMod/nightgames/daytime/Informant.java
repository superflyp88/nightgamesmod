...
public class Informant extends Activity {
    ...
    private final String REMOVE_PREFIX = "Remove: ";
    private final String RETURN_PREFIX = "Bring Back: ";
    ...
    private boolean doIntro(String choice) {
        ...
        if (player.getRank() >= 1 && !Global.checkFlag(Flag.rank1)) {
            ...
            Global.gui().message(
                            "The spot where you're suppose to meet Aesop is quiet again. Given the number of people in the Quad during the day, "
                            + "you're starting to feel like people are intentionally avoiding this bench. You don't have too long to think about "
                            + "it though, Aesop shows up shortly after you do.<br/><i>\"Always good to see my favorite client. What kind of tale "
    ...
    private void meetBroker() {
        Global.gui().message(String.format(
                        ...
                        + "probably just a delayed reaction to the eerie atmosphere last night. You're here to meet an upperclassman "
                        + "who will apparently provide valuable information and possibly advice. At least that's what you were led "
                        + "to believe last night. Well, any information would be welcome. It's not like anyone else will talk about "
                        + "the 'night games.' Fortunately, the bench in the shadow of the Liberal Arts building where you're supposed "
                        + "to meet is away from the normal foot traffic. You should be able to talk freely without having to worry "
                        + "about passersby overhearing you.<br/>You take a seat and idly fiddle with your phone while you wait. Less "
                        + "than a minute later, a somewhat tall guy who looks a few years older than you sits down next to you.<br/><br/>"
                        + "<i>\"Good match last night for a bunch of virgins. There's a lot of potential in your year.\"</i><br/>"
                        + "Presumably this is Tyler, the information broker you're here to meet - that or a crazy person.<br/>"
                        + "<i>\"Everyone in the loop calls me Aesop: as long as you can pay, I'll have a fable for you.\"</i><br/><br/>"
                        + "Also, you let it pass without comment a second ago, but you feel compelled to point out that you aren't "
                        + "actually a virgin.<br/><i>\"I meant that it was your first match. Everyone this year is coming in with some "
                        + "sexual experience, but your first match is a whole other virginity. You're either in the loop or out of it "
                        + "and the only people in the loop are current or former participants.\"</i><br/>That would imply that 'Aesop' "
                        + "here is also a participant.<br/><i>\"Hell yeah, I used to rock some pussy. Male players are rare, so we have "
                        + "to make up for it by being more impressive. There are big expectations hanging over any dudes entering the "
                        + "games. Anyway, I made a tidy profit in my matches, but I realized the big money is in selling secrets in a "
                        + "world where everything is secret. Don't worry, you're getting my I'm-mentoring-a-total-newbie-and-don't-care-"
                        + "if-I-make-a-profit-right-now discount. Besides, most of what you need right now is dime-a-dozen common sense, "
                        + "so I'll even throw you some free advice. Down the road I'm expecting you to reach the levels where you can "
                        + "afford my premium secrets. I have some much wealthier clients who will set me up for life if I can get them "
                        + "the really juicy information.\"</i><br/><br/>It's nice to know you're a stepping stone to your broker's "
                        + "financial security, but how helpful is this dime-a-dozen common sense going to be?<br/><i>\"Obviously this "
                        + "is a physical competition, so conventional exercise is a good idea. You also need to condition your sex drive. "
                        + "I recommend spending some time with the nastiest, most extreme porn you can get your hands on. After a few "
                        + "hours of that, everything else will seem milder in comparison. Lastly, don't underestimate the effect of "
                        + "confidence in a fight. If you can consistently dish out a good fucking, you may find things going your way "
    ...
    private void rankOneEvent() {
        ...
        Global.gui().message(String.format(
                        "You go to meet Aesop at the usual spot, but today he's not alone. The woman who initially recruited you - named "
                        + "Maya, if you remember correctly - is waiting for you. Looking at her next to Aesop, she's probably not much "
                        + "older than he is, but something about her makes her seem more mature. She has modest clothes, glasses and long "
                        + "black hair tied in a braid that runs down her back. She smiles gently as you approach. <i>\"Congratulations on "
                        + "your new rank. You probably won't realize what an honor it is yet, but you've proven yourself worthy of learning "
                        + "powerful and potentially dangerous secrets. Because Tyler here has made a business out of such secrets, I'm sure "
                        + "he'll be thrilled to offer you details.\"</i><br/><br/>Aesop steps forward as if on cue. You get the impression "
                        + "they've done this a few times. <i>\"Congratulations. From here on is where your mind gets blown. I'm now allowed "
                        + "to sell you some more valuable secrets and you now have the income to afford them. I can't afford to give you as "
                        + "big a discount anymore, but if you're willing to pay, I can help you find some extremely rare and powerful "
                        + "artifacts, technology you couldn't imagine, a master who will train you in legendary martial arts, even magic."
                        + "\"</i><br/><br/>While you're still processing this, Maya speaks up again. <i>\"I appreciate that you haven't "
                        + "mentioned the Game to any outsiders. If the wrong people heard what we're doing, there would be an unpleasant "
                        + "scandal. As you and your fellow competitors gain access to these gifts, the importance of secrecy grows. These "
                        + "are secrets that the general public is not ready for.\"</i><br/><br/>This is all very far-fetched. The skeptical "
                        + "part of your brain is telling you this is an elaborate scam, but all the money you're paying Aesop is coming "
                        + "from the Game. Besides, if they can operate secretly on campus at this scale, you're ready to believe your "
                        + "mysterious benefactor is capable of anything. What do you really have to lose?<br/><br/>Maya, having apparently "
                        + "finished her part, excuses herself with a small bow. Aesop clears his throat once she's out of earshot. "
                        + "<i>\"In addition to the new services you have access to, I can arrange some more competition for you if you're "
                        + "interested. Now I'm not trying to imply that you're the sort of greedy %s who isn't satisfied with four people "
    ...
    private void handleSupplies() {
        Global.gui().message("<i>\"As you were probably told when you entered, there are rules restricting the clothes you can wear to a match. "
                        ...
                        + "items.\"</i> There can't be a lot of stores that sell sexfight supplies, unless there's more demand for it than you "
                        + "thought.<br/><i>\"I can give you the address of a nearby sex shop, of course. If you do go there, don't bother with "
                        + "any of the cheap crap. Their top shelf items should be just barely sufficient. Of course, you can also find useful "
                        + "stuff at normal stores. A simple energy drink from the campus bookstore can keep you on your feet if you're running "
                        + "out of steam. If you're the type to sneak around preparing traps, you can find parts in the local hardware store. If "
                        + "you're feeling particularly thrifty, you can raid the storage in the engineering workshops or under the dining hall. "
                        + "No one really cares if some random crap disappears from there during the night.\"</i><br/>This is all kinda mundane "
    ...
    private void handleCompetition() {
        ...
        Global.gui().message(String.format(
                        ...
                        + "</i><br/>Aesop laughs a bit at his own crappy joke.<br/><i>\"In all seriousness, you should definitely get to know "
                        + "your enemies. This isn't a zero-sum game, everyone who participates can make some money. Obviously there would be "
                        + "issues if you tried to doctor the results of a match, but it's not uncommon for players to collaborate during their "
                        + "free time. You can swap strategies, do some training together or do some 'training together' as the case may be.\""
                        + "</i><br/>He lets out the same humorless laugh again. That one didn't even really qualify as a joke.<br/><br/><i>"
                        + "\"Competitors pushing each other to up their game makes for an overall higher level of play and makes the matches "
                        + "more interesting. That makes everyone happy. Besides, all your opponents are of A+ caliber, you lucky %s. I don't "
                        + "blame you for wanting to get to know them better. Just give me the name of the one you're interested in (with a "
                        + "nominal fee of course) and I'll give you some background, some interests, and some places where you're likely to "
    ...
    private void handleCustomNpcRecruitment(String choice) {
        ...
        try {
            ...
            if (data.effects.stream().allMatch((effect) -> effect.execute(null, copy, null))) {
                ...
                Global.gui().message("You cannot pay the cost.<br/><br/>");
            }
    ...
    private void handleNewCompetitorChoices(String choice) {
    ...
    private void displayCompetitionInfo() {
    ...
    /** Presents all options returned from buildOptions(), running the one that matches
     ...
     * to buildOptions(), or they won't be selectable. I'm too lazy to write a proper registry. */
    private abstract class CostlyOption {
        public abstract String name();
        
        /** Amount this option costs to select */
        public abstract int cost();
        
        /** Override to implement activity */
        public abstract void run();
        
        /** Returns true if this option should be provided to the player */
        public abstract boolean available();
        
        /** Informs player that they can't afford this option. */
        public final void printNoMoney() {
            Global.gui().message("You don't have enough money.<br/><br/>");
        }
         ...
         * is run. */
        protected Optional<Flag> setOnRun() {
            return Optional.empty();
        }
    }
    
    private List<CostlyOption> buildOptions() {
        ArrayList<CostlyOption> options = new ArrayList<>();
        options.add(new MeditationOption());
        options.add(new BlackMarketOption());
        options.add(new CassieOption());
        options.add(new AngelOption());
        options.add(new MaraOption());
        options.add(new JewelOption());
        options.add(new ExoticArtifactsOption());
        options.add(new BodyShopOption());
        options.add(new MartialArtsOption());
        options.add(new MagicOption());
        options.add(new TechOption());

        return options;
    }
    
    private class MeditationOption extends CostlyOption {
        private static final String NAME_PREFIX = "Meditation";

        @Override
        public String name() {
            return NAME_PREFIX + ": $" + cost();
        }
        ...
        public void run() {
            Global.gui().message(
                            "You ask if Aesop has any advice on how to condition yourself mentally. Picking up details in the environment and your "
                            + "opponents' behavior seems to be an important element of winning the matches. Also, since you can only be defeated by "
                            + "orgasming, learning techniques to control your arousal would be valuable.<br/>Aesop hesitates for a few seconds "
                            + "before speaking. <i>\"I can point you in the right direction, but I should warn you that there's a tradeoff that every "
                            + "player who pursues this path has to face. The two aspects of mental training that you just mentioned are conflicting. "
                            + "If you sharpen your senses to be more aware of your opponents, your sense of touch will also be sharpened and you'll be "
                            + "more vulnerable to their 'attacks.' On the other hand, you can train yourself to block out the pleasure being inflicted "
                            + "on you, but you risk your brain filtering out crucial information.\"</i><br/<i>\"If you're still interested, there's a "
                            + "girl named Suzume who leads guided meditation on campus. If you ask nicely, she may give you a private lesson to push you "
                            + "in either direction.\"</i>");
        }

        @Override
        protected Optional<Flag> setOnRun() {
            return Optional.of(Flag.meditation);
        }
    ...
    private class BlackMarketOption extends CostlyOption {
        private static final String NAME_PREFIX = "Black Market";
        ...
        @Override
        public void run() {
            Global.gui().message("<i>\"If you're looking for something you can't purchase at a reputable store - say, for example, powerful "
                            + "aphrodisiacs or chemicals that can rapidly dissolve synthetic clothing without harming skin - I know a guy on "
                            + "campus.\"</i><br/>You hand over a considerable sum of cash and Aesop slides you a piece of paper.<br/><i>\"The "
                            + "dude's name is Mike Ridley, definitely an asshole, but he can get you want you want. He probably won't ask what "
                            + "you want it for and you shouldn't volunteer the information. He mostly sells pot to normal students. He's not "
                            + "in the loop, so to speak.\"</i>");
        }

        @Override
        protected Optional<Flag> setOnRun() {
            return Optional.of(Flag.blackMarket);
        }

        @Override
        public boolean available() {
            return (Global.checkFlag(Flag.basicStores) && !Global.checkFlag(Flag.blackMarket));
        }
    }

    private class CassieOption extends CostlyOption {
        private static final String NAME_PREFIX = "Cassie";
        ...
        public void run() {
            Global.gui().message(
                            "<i>\"Cassie Brooke, huh? Sweet girl, a little shy, a little geeky, never been in trouble in her life. She's not the "
                            + "type of girl who usually enters sexfights, but she's adapting to it pretty well, all things considered. This is "
                            + "apparently a matter of necessity for her, her family doesn't have a whole lot of money, doesn't get enough financial "
                            + "aid, and they don't want her getting a job until she graduates. Of course, I seriously doubt they'd approve of this "
                            + "either. Hopefully she's clever enough to explain away her sudden income.<br/>I can give you her normal schedule, but "
                            + "you shouldn't need any help finding her. The two of you are in a couple classes together this semester.\"</i><br/><br/>"
                            + "It's true, you see her in class regularly, and before the two of you entered the matches, you chatted before and after "
                            + "class pretty frequently. Now that you're sharing a secret hobby though, you never get a chance to really talk with her "
                            + "while the other students are around. After class she seems to disappear to quickly that you're starting to suspect she's "
                            + "actively avoiding you.<br/><i>\"I said she was shy, didn't I? In the afternoon, she spends a lot of time studying in the "
                            + "library like a good student. Seems like a good place to talk to her privately.\"</i>");
        }

        @Override
        protected Optional<Flag> setOnRun() {
            return Optional.of(Flag.CassieKnown);
        }

        @Override
        public boolean available() {
            return Global.checkFlag(Flag.girlAdvice) && !Global.checkFlag(Flag.CassieKnown);
        }
    }

    private class AngelOption extends CostlyOption {
        private static final String NAME_PREFIX = "Angel";
        ...
        public void run() {
            Global.gui().message(
                            "<i>\"Angel Hart, there's a hell of a name. Three words for you: Beautiful Blonde Nymphomaniac. Oh baby, that's "
                            + "a delicious combination. None of that is news to you, of course, because it's obvious within ten seconds of "
                            + "meeting her, but I just had to say it out loud. mmmm...<br/>Anyway, back on topic. He legal name is Angelina, "
                            + "but she never uses it. Her father is rich and influential, the vice president of a company you probably haven't "
                            + "heard of, but is a bit of a heavyweight in the financial world. Angel has probably never wanted for "
                            + "anything in her life. She's always been popular with both boys and girls. Over the past couple years she's had "
                            + "a series of boyfriends and a couple girlfriends, none of whom have ever lasted more than a week. She'll throw "
                            + "just about anyone who piques her interest onto the bed, but tends to get bored quickly. If you want her to take "
                            + "you seriously, you'll need to impress her. She likes being in control, but I bet she turns to jello if you can "
                            + "beat her at her own game. Talking to her may be tough. I can give you some locations where she and her friends "
                            + "tend to hang out, but you're going to have a hell of a time catching her alone.\"</i>");
        }

        @Override
        protected Optional<Flag> setOnRun() {
            return Optional.of(Flag.AngelKnown);
        }

        @Override
        public boolean available() {
            return Global.checkFlag(Flag.girlAdvice) && !Global.checkFlag(Flag.AngelKnown);
        }
    }

    private class MaraOption extends CostlyOption {
        private static final String NAME_PREFIX = "Mara";
        ...
        @Override
        protected Optional<Flag> setOnRun() {
            return Optional.of(Flag.MaraKnown);
        }

        @Override
        public boolean available() {
            return Global.checkFlag(Flag.girlAdvice) && !Global.checkFlag(Flag.MaraKnown);
        }
    }

    private class JewelOption extends CostlyOption {
        private static final String NAME_PREFIX = "Jewel";
        ...
        @Override
        protected Optional<Flag> setOnRun() {
            return Optional.of(Flag.JewelKnown);
        }

        @Override
        public boolean available() {
            return Global.checkFlag(Flag.girlAdvice) && !Global.checkFlag(Flag.JewelKnown);
        }
    }

    private class ExoticArtifactsOption extends CostlyOption {
        private static final String NAME_PREFIX = "Exotic Artifacts";
        ...
        @Override
        protected Optional<Flag> setOnRun() {
            return Optional.of(Flag.blackMarketPlus);
        }
    ...
    private class BodyShopOption extends CostlyOption {
        private static final String NAME_PREFIX = "Body Shop";
        ...
        @Override
        protected Optional<Flag> setOnRun() {
            return Optional.of(Flag.bodyShop);
        }

        @Override
        public boolean available() {
            return Global.checkFlag(Flag.rank1) && !Global.checkFlag(Flag.bodyShop);
        }
    }

    private class MartialArtsOption extends CostlyOption {
        private static final String NAME_PREFIX = "MartialArts";
        ...
        public void run() {
            Global.gui().message(
                            ...
                            + "Fucking hell. If nothing else, at least Aesop is giving you a lesson in economics.");
        }

        @Override
        protected Optional<Flag> setOnRun() {
            return Optional.of(Flag.dojo);
        }

        @Override
        public boolean available() {
            return Global.checkFlag(Flag.rank1) && 
                   Global.checkFlag(Flag.meditation) && 
                   !Global.checkFlag(Flag.dojo);
        }
    }

    private class MagicOption extends CostlyOption {
        private static final String NAME_PREFIX = "Magic?";
        ...
        @Override
        protected Optional<Flag> setOnRun() {
            return Optional.of(Flag.magicstore);
        }

        @Override
        public boolean available() {
            return Global.checkFlag(Flag.rank1) && !Global.checkFlag(Flag.magicstore);
        }
    }

    private class TechOption extends CostlyOption {
        private static final String NAME_PREFIX = "Tech";
        ...
        @Override
        protected Optional<Flag> setOnRun() {
            return Optional.of(Flag.workshop);
        }

        @Override
        public boolean available() {
            return Global.checkFlag(Flag.rank1) && !Global.checkFlag(Flag.workshop);
        }
    }
}
