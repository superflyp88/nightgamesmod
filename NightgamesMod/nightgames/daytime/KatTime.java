        ...
        if (npc.getAffection(player) > 0) {
            ...
            Global.gui().message(
                            "You decide to look for Kat and see if she's interested in spending some time together. You don't have any way to contact her directly, "
                                            ...
                                            + "carrying a paperback book that she's either just been reading or is looking for a place to read.<br/><br/>You call out to Kat and for a moment, she looks like "
                                            ...
                                            + "Kat's shoulder and leads her away. <i>\"Sorry, we're in a bit of a hurry.\"</i> Kat looks like she wants to say something, but can't get the words out.<br/><br/>After they"
            ...
            Global.gui().message(
                            "You head out to the campus gardens, hoping to find Kat so you can spend some time together. You aren't searching long before you find her reading "
                                            ...
                                            + "was way more forward than you were expecting. You don't mind, of course.<br/><br/>You pull down Kat's pants and slip your hand into her underwear. Under your skilled touch, "
                                            ...
                                            + "slide her panties down to get better access to her girl parts and she ends up kicking them off completely.<br/><br/>Just as you're about to finish Kat off, she grabs your "
                                            ...
                                            + "shy. Oh, I also do a lot more meowing. That's totally the Cat's fault.\"</i><br/><br/>Ok, you get the general idea. You just aren't sure what to call her when she's like this. "
                                            ...
                                            + "to lick her clit very long to make her orgasm. She arches her back and lets out a breathless moan as she hits her peak.<br/><br/>You sit next to Kat and gently stroke her "
    ...
    public void subVisit(String choice) {
        ...
        if (choice.equals("Sex")) {
            ...
            if (!player.has(Trait.tease)) {
                Global.gui().message("<br/><br/><b>You've learned to take pride in your teasing.</b>");
            ...
            if (!player.has(Trait.aikidoNovice)) {
                Global.gui().message("<br/><br/><b>You're now more familiar with the art of counter attacking.</b>");
            ...
            Global.gui().message("You know that Kat's power comes from an animal spirit "
                            ...
                            + "You've most certainly 'met' her.<br/><br/><i>\"Aisha is really nice. When "
